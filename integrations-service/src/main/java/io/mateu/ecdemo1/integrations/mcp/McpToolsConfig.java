...
public class McpToolsConfig {
    ...
    @Bean
    public ToolCallbackProvider integrationsToolCallbackProvider(IntegrationMcpTools integrationTools) {
        return MethodToolCallbackProvider.builder()
                .toolObjects(integrationTools)
                .build();
    }
     ...
     */
    @Bean
    public List<McpServerFeatures.SyncPromptSpecification> systemContextPrompts(IntegrationMcpTools integrationTools) {
        ...
        return List.of(new McpServerFeatures.SyncPromptSpecification(prompt,
                (exchange, request) -> new McpSchema.GetPromptResult(
                        ...
                        List.of(new McpSchema.PromptMessage(
                                McpSchema.Role.USER,
                                new McpSchema.TextContent(integrationTools.getSystemContext()))))));
    }
}
