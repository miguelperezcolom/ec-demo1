...
APPS="shell shell-redwood gateway booking content users ia-agent ia-control-plane api-mcp control-shell control-shell-redwood partners crs-integration-service mapping-service pms-integration-service opera-mock communication-service integrations-service"
