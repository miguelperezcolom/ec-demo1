package io.mateu.ecdemo1.controlshellredwood.infra.in.ui;
...
/**
 * The control console rendered by Redwood — a copy of {@code control-shell} whose only difference
 * is {@code io.mateu:redwood} in place of {@code io.mateu:vaadin-lit}. See
 * {@code shell-redwood}'s ShellHome for why the pair exists and why neither needs a Keycloak
 * client of its own.
 */
/**
