...
public class McpToolsConfig {
    ...
    @Bean
    public ToolCallbackProvider communicationToolCallbackProvider(CommunicationMcpTools communicationTools) {
        return MethodToolCallbackProvider.builder()
                .toolObjects(communicationTools)
                .build();
    }
     ...
     */
    @Bean
    public List<McpServerFeatures.SyncPromptSpecification> systemContextPrompts(CommunicationMcpTools communicationTools) {
        ...
        return List.of(new McpServerFeatures.SyncPromptSpecification(prompt,
                (exchange, request) -> new McpSchema.GetPromptResult(
                        ...
                        List.of(new McpSchema.PromptMessage(
                                McpSchema.Role.USER,
                                new McpSchema.TextContent(communicationTools.getSystemContext()))))));
    }
}
