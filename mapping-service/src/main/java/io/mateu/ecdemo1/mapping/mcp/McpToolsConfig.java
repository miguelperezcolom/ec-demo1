...
public class McpToolsConfig {
    ...
    @Bean
    public ToolCallbackProvider mappingToolCallbackProvider(MappingMcpTools mappingTools) {
        return MethodToolCallbackProvider.builder()
                .toolObjects(mappingTools)
                .build();
    }
     ...
     */
    @Bean
    public List<McpServerFeatures.SyncPromptSpecification> systemContextPrompts(MappingMcpTools mappingTools) {
        ...
        return List.of(new McpServerFeatures.SyncPromptSpecification(prompt,
                (exchange, request) -> new McpSchema.GetPromptResult(
                        ...
                        List.of(new McpSchema.PromptMessage(
                                McpSchema.Role.USER,
                                new McpSchema.TextContent(mappingTools.getSystemContext()))))));
    }
}
