...
public class McpToolsConfig {
    ...
    @Bean
    public ToolCallbackProvider partnerToolCallbackProvider(PartnerMcpTools partnerTools) {
        return MethodToolCallbackProvider.builder()
                .toolObjects(partnerTools)
                .build();
    }
     ...
     */
    @Bean
    public List<McpServerFeatures.SyncPromptSpecification> systemContextPrompts(PartnerMcpTools partnerTools) {
        ...
        return List.of(new McpServerFeatures.SyncPromptSpecification(prompt,
                (exchange, request) -> new McpSchema.GetPromptResult(
                        ...
                        List.of(new McpSchema.PromptMessage(
                                McpSchema.Role.USER,
                                new McpSchema.TextContent(partnerTools.getSystemContext()))))));
    }
}
