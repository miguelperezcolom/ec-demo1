...
// ── cuerpo: huéspedes + operativa en dos columnas; en el check-in, envuelto en un
  ...
  private io.mateu.uidl.data.Drawer drawerExtras(Stay stay) {
    var seleccionados = stay.addOns().stream()
        .map(io.mateu.ecdemo1.frontoffice.domain.stay.SelectedAddOn::addOnId)
  ...
  private Component elegirHabitacion(Stay stay, boolean conTitulo) {
    ...
    content.add(io.mateu.uidl.data.ResourceGrid.builder()
        ...
        .items(FrontOffice.rooms().findByFloor(12).stream()
            .map(room -> io.mateu.ecdemo1.frontoffice.ui.checkin.HabitacionStep.item(
  ...
  private boolean lateCheckoutContratado(io.mateu.ecdemo1.frontoffice.domain.folio.Folio folio) {
  ...
  private List<String> cronologia(io.mateu.ecdemo1.frontoffice.domain.stay.Incident i) {
  ...
  public Object handleAction(String actionId, HttpRequest httpRequest) {
    return switch (actionId) {
      ...
      case "escanearPax" -> {
        ...
        var pax = paxDe(httpRequest);
        var nombre = io.mateu.ecdemo1.frontoffice.ui.common.Paxes.nameOf(stayId, pax);
        ...
        yield io.mateu.uidl.data.LongTask.create("Escaneando el documento de " + nombre + "…")
            ...
            .run(progress ->
                reactor.core.publisher.Flux.range(1, 4)
                    ...
                    .map(i -> {
                      if (i == 4) {
                        io.mateu.ecdemo1.frontoffice.ui.common.Paxes.scan(idEstancia, pax);
                      }
      ...
      case "guardarPax" -> {
        io.mateu.ecdemo1.frontoffice.ui.common.Paxes.register(
            stayId, paxSeleccionado, paxDocumento, paxNombre, paxEmail, paxTelefono);
        var nombre = io.mateu.ecdemo1.frontoffice.ui.common.Paxes.nameOf(stayId, paxSeleccionado);
        paxDocumento = null;
        paxNombre = null;
        paxEmail = null;
        paxTelefono = null;
      ...
      case "crearIncidencia" -> {
        var tipo = io.mateu.ecdemo1.frontoffice.domain.stay.IncidentType.valueOf(
        ...
        var incidencia = new io.mateu.ecdemo1.frontoffice.domain.stay.Incident(
  ...
  public void onHydrated(HttpRequest httpRequest) {
    if (stayId == null || stayId.isBlank()) {
      stayId = io.mateu.ecdemo1.frontoffice.ui.common.GuestHeaders.idFromRoute(
  ...
  private io.mateu.uidl.data.Drawer drawerNuevaIncidencia() {
    ...
    contenido.add(StatusList.builder()
        ...
        .items(java.util.Arrays.stream(
                io.mateu.ecdemo1.frontoffice.domain.stay.IncidentType.values())
  ...
  private String tipoDe(io.mateu.ecdemo1.frontoffice.domain.room.Room room) {
